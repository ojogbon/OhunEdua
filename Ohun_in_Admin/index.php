...
<body>
  ...
  <div class="header">
       <div class="pull-left">
           <div class="logo"><a href="index.php"><span style="font-size:9px;">OhunEdua Admin</span></a></div>
                                    ...
                                    <div class="basic-form">
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <p>Company Mail </p>
                                                <input type="email" name="admin_usename" class="form-control input-default " placeholder="Email" required>
                                            </div>
                                            <div class="form-group">
                                                <p>Password </p>
								...
								<button type="submit" name="add_staff" class="btn btn-primary btn-flat m-b-30 m-t-30">Login</button>
                                        ...
                                        <?php
                                                    			 if(isset($_POST["add_staff"])){
                                                                  ...
                                                                  $sql = "select id from company where email= '$admin_usename' and password = '$admin_password'";

                                                                  if($company->getAllCompanyBySql($sql)[0]["id"]){
                                                                    echo "<script type='text/javascript'>alert('Login Successful Admin');</script>";;
                                                                        $_SESSION["adminId"] = $company->getAllCompanyBySql($sql)[0]["id"];
