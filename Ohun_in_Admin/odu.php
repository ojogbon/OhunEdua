                            ...
                            <div class="card alert">
                                <div class="card-header">
                                    ...
                                    <div class="card-header-right-icon">
										 <ul>
											<li class="card-close"><a href="add_odu.php"><i class="ti-plus"></i>Add Odu </a></li>
										</ul>
									</div>
                                </div>
                                <div class="card-body">
                                    <table class="table table-responsive">
                                        ...
                                        <tbody>
                                        <?php
                      $query = "select * from verse  where officer_id ='".$company_id."' order by id desc";
                      ...
                      foreach ($oduIfas as $oduIfa  => $value){
                        ...
                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $oduIfas[$oduIfa]["title"];?></td>
                                                 <td class="color-primary"><?php echo  $oduIfas[$oduIfa]["date"];?></td>
