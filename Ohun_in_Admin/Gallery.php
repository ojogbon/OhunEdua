                                      ...
                                      <div class="card-block">
                                                  <form method="post" enctype="multipart/form-data">
                                                      ...
                                                      <div class="form-group row">
                                                            <label for="Amount" style="    font-family: inherit;" class="col-sm-2 col-form-label">Gallery Image</label>
                                                          <div class="col-sm-10">
                                                  ...
                                                  <?php
                                                                     if(isset($_POST["save"])){
                                                                              ...
                                                                              $diretry = "../forAllImage/".$filen;

                                                                                  $query  = "INSERT INTO `gallery`(`id`, `image`, `path`, `date`, `status`)
                                                                                  VALUES (null,'$filen','$diretry',now(),'0')";
                                                                              ...
                                                                              {
                                                                                 echo "<p style='color:#0F0'> <script type='text/javascript'>alert('Gallery added successfully');</script>";;
